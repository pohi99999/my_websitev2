...
const statsData = {
    hu: [
        { value: 95, suffix: '+', label: 'AI építőelem', icon: Bot },
        { value: 53, label: 'Integrációs pont', icon: Cpu },
        { value: 3, label: 'Nyelv', icon: Globe },
        { value: '24/7', label: 'Élő működés', icon: Zap, live: true },
    ],
    en: [
        { value: 95, suffix: '+', label: 'AI building blocks', icon: Bot },
        { value: 53, label: 'Integrations', icon: Cpu },
        { value: 3, label: 'Languages', icon: Globe },
        { value: '24/7', label: 'Live operation', icon: Zap, live: true },
    ],
    de: [
        { value: 95, suffix: '+', label: 'KI-Bausteine', icon: Bot },
        { value: 53, label: 'Integrationen', icon: Cpu },
