...
export const metadata = {
  ...
  alternates: { canonical: '/portfolio/palyazat-radar' },
  openGraph: { title: 'Pályázat Radar — Soha többé ne maradj le pályázatról', description: 'Automatikus pályázat- és jogszabályfigyelés KKV-knak, heti riporttal.', url: '/portfolio/palyazat-radar', type: 'article', locale: 'hu_HU' },
};
    ...
    <div className="min-h-screen text-white">
      <section className="relative py-12 px-6 pt-24 pb-16">
        <div className="max-w-5xl mx-auto">
          <GsapFadeIn>
            <Link href="/portfolio" className="inline-flex items-center gap-2 text-amber-400 hover:text-amber-300 mb-8 transition-colors"><ArrowLeft className="w-4 h-4" /> Vissza a Portfólióhoz</Link>
