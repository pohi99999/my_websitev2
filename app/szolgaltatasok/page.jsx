...
import { Cpu, Globe, Zap } from "lucide-react"; // Ikonok a szolgáltatásokhoz

export default function SzolgaltatasokPage() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center">
      {/* Szolgáltatások oldal Videója */}
      <VideoBackground videoSrc="https://res.cloudinary.com/dbrwg0av5/video/upload/v1765517737/1_as6ulx.mp4" />
