  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ marginTop: 26, fontSize: 86, fontWeight: 800, letterSpacing: -2 }}>Blog & Tudástár</div>
        ...
        >
          Cikkek, white paper anyagok, technológia és a Brunella Agent System kulisszatitkai.
        </div>

        <div style={{ marginTop: 42, display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          {['AI ügynökök', 'Automatizálás', 'Filozófia', 'Tech mélyfúrás'].map((label) => (
            <div
              key={label}
              style={{
                fontSize: 22,
