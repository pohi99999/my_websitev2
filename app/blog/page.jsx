    ...
    <main className="relative min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="glass-panel p-6 rounded-2xl border border-white/10 hover:border-pink-500/50 transition-all duration-300 backdrop-blur-md bg-black/40">
            ...
            <p className="text-gray-300 mb-4">
              Hogyan jutottunk el a fekete doboztól az átlátható AI operációs rendszerig.
            </p>
