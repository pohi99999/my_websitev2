...
export default function HomePage() {
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center">
      <VideoBackground videoSrc="/home.mp4" />
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-white text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <Link
            href="/szolgaltatasok"
            className="group relative px-8 py-4 bg-blue-600 hover:bg-blue-700 rounded-full transition-all duration-300 flex items-center justify-center"
          >
          ...
          <Link
            href="/kapcsolat"
            className="px-8 py-4 border-2 border-white/30 hover:border-white rounded-full transition-all duration-300 backdrop-blur-sm hover:bg-white/10 font-bold text-lg"
          >
            Kapcsolat
          </Link>
        </div>
