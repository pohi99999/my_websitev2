      ...
      <div className="relative min-h-screen bg-transparent text-white overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 pointer-events-none" aria-hidden="true">
          <iframe
            ...
            title="Brunella Agents Background"
            frameBorder="0"
        ...
        <div className="relative z-10">
            ...
            <div className="relative z-10 max-w-4xl mx-auto text-center">
              ...
              <GsapFadeIn>
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                  Autonm AI gynkk, amelyek a legbonyolultabb zleti feladatokat vgzik el.
                  Takartsa meg az id 80%-t, fokozza a termelkenysget, cskkentse a kltsgeket.
                </p>
            ...
            <div className="max-w-7xl mx-auto">
              <GsapFadeIn>
                <div className="text-center mb-16">
                  <h2 className="section-title">F Jellemzk</h2>
                  <p className="section-subtitle">
                    Mindaz, amit az rtelmes automatizlshoz szksges
                  </p>
                </div>
              </GsapFadeIn>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                  ...
                  { label: 'Teleptett gynkk', value: '50K+' },
                  { label: 'Automatizlt Feladatok', value: '100M+' },
                  { label: 'vente Megtakartott ra', value: '5M+' },
                ].map((stat, idx) => (
          ...
          <section className="py-24 px-6 bg-white/5">
            <div className="max-w-7xl mx-auto">
              <GsapFadeIn>
                <div className="text-center mb-16">
                  <h2 className="section-title">razsi Csomagok</h2>
                  <p className="section-subtitle">Rugalmas razs az n ignyeihez</p>
                </div>
              </GsapFadeIn>
          ...
          <section className="py-24 px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  { step: 1, title: 'Ltrehozs', desc: 'Definilja az gynk cljait s viselkedsi szablyait' },
                  { step: 2, title: 'Tants', desc: 'Az gynk tanulja a specifikus feladatokat s munkafolyamatokat' },
                  { step: 3, title: 'Telepts', desc: 'lstse az gynkt a termelsi krnyezetben' },
          ...
          <section className="py-24 px-6 bg-white/5">
            <div className="max-w-7xl mx-auto">
              <GsapFadeIn>
                <div className="text-center mb-16">
                  <h2 className="section-title">Mit Mondanak az gyfeleink</h2>
                </div>
              </GsapFadeIn>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {[
                  { name: 'Dr. Nagy Lszl', role: 'CTO, Tech Corp', quote: 'Az gynkk feltltttk a termelkenysg 60%-val.' },
                  { name: 'Kovcs Zsuzsanna', role: 'Operations Manager', quote: 'A 80%-val cskkent az adminisztratv munka, sokkal tbb id jut a stratgira.' },
                ].map((testimonial, idx) => (
                  <GsapFadeIn key={idx} delay={idx * 0.2}>
                    <SpotlightCard className="p-6">
            ...
            <div className="max-w-4xl mx-auto">
              <GsapFadeIn>
                <SpotlightCard className="p-12 sm:p-16 text-center">
                  <h2 className="text-4xl font-bold mb-6 gradient-text">Kszljn a kvetkez szintre</h2>
                  <p className="text-lg text-gray-300 mb-8">
                    Egyedi Brunella Agents dem s konzultcis az n szksgleteire.
                  </p>
